...
export default ({
  ...
  return class extends Component {
    ...
    componentWillMount() {
      this.panResponder = PanResponder.create({
        ...
        onStartShouldSetPanResponder: ({ nativeEvent: { touches } }, { x0, y0 }) => {
          console.log("inside onStartShouldSetPanResponder");
        ...
        onMoveShouldSetPanResponder: ({ nativeEvent: { touches } }) => {
          console.log("inside onMoveShouldSetPanResponder");
          return touches.length === 1;
        },

        onPanResponderMove: (evt, { dx, dy }) => {
          console.log("inside onPanResponderMove");
    ...
    handlePanResponderRelease = () => {
      console.log("inside handlePanResponderRelease");
